...
namespace eShopDMZ.Controllers
{
    public class FornecedorsController : Controller
    {
        ...
        {
            return View(await _context.TBFornecedor.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var fornecedor = await _context.TBFornecedor
        ...
        public async Task<IActionResult> Create([Bind("IDFornecedor,Nome,Endereco")] TBFornecedor fornecedor)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var fornecedor = await _context.TBFornecedor.FindAsync(id);
            if (fornecedor == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDFornecedor,Nome,Endereco")] TBFornecedor fornecedor)
        {
        ...
        {
            return _context.TBFornecedor.Any(e => e.IDFornecedor == id);
        }
    }
}
